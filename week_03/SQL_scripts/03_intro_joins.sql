...
SELECT pub_name, COUNT(title_id) AS count_titles
FROM publishers 
>>>>>>> 84436f632e585f2c67d7461292df235e9756ab7c
INNER JOIN titles
ON publishers.pub_id = titles.pub_id
GROUP BY pub_name;
...
We could declare our sales table first, our titles table second,
 and use a RIGHT JOIN to ensure that our query returns a record for every title (even the ones that did not have any sales).*/
